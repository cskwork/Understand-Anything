...
**Localized output:** Korean is the default output language. Use `--language` to generate content in another supported language:

```bash
# Korean content is generated by default (knowledge graph node descriptions and Dashboard UI)
/understand

# Override the output language when needed
/understand --language zh

# Supported languages: ko (default), en, zh, zh-TW, ja, ru
```
